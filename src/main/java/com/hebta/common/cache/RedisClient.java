...
public class RedisClient {
     ...
     * @param value
     */
    public <T> void setHashModel(String key, String hashKey, Object value, T model){
        HashOperations<String, Object, Object> hash = redisTemplate.opsForHash();
     ...
     * @return
     */
    public <T> T getHashModel(String key, String hashKey, Class<T> clazz){
        HashOperations<String, Object, Object>  hash = redisTemplate.opsForHash();
        Object data = hash.get(key,hashKey);
        if (null == data) {
            return null;
        }
